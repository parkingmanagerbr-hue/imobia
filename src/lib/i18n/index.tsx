...
const STORAGE_KEY = 'imobia.lang';

const SUPPORTED = new Set<Lang>(LANGS.map((l) => l.code));

/** Resolve a BCP-47 / browser code to a supported language. */
...
/** Translate a key for the given language, falling back to EN then the key itself. */
...
export function useI18n(): I18nCtx {
  ...
  if (ctx) return ctx;
  // Safe fallback outside the provider (e.g. initial server render).
